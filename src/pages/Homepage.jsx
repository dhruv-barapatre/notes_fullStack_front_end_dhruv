        ...
        <div class="row align-items-center">
          <div class="col-lg-6 order-lg-1 ms-auto d-none d-lg-block">
            <div class="mb-5 mb-lg-0 w-11/10 position-relative">
              ...
              {/* <!-- Decorations --> */}
              <div class="position-absolute bottom-0 start-72 h-64 w-64 mt-n4 transform translate-y-n1/2 translate-x-n1/2 gradient-bottom-right start-purple-400 end-cyan-500 filter blur-100 rounded-4 p-5">
                {" "}
              </div>
            </div>
          </div>
          <div class="col-lg-6 order-md-0">
            ...
            <h1 class="ls-tight font-bolder display-3 mb-5">
              Dive into the latest stories, trends, and tips from industry
              experts.
            </h1>
            {/* <!-- Text --> */}
            <p class="lead mb-10">
